...
public class Test37 {
    ...
    private static boolean[][] TABELA02 = {
        {T, T, T, T, T, T, F, T, F, T, F, T, F, T, F},
        {F, T, T, F, F, F, F, F, F, T, T, T, F, T, T},
        {T, T, T, F, F, F, T, F, F, T, T, F, T, T, F},
        {T, F, T, F, F, F, F, T, F, T, F, F, F, T, F},
        {T, T, T, T, F, T, F, T, T, F, F, T, F, T, F},
    };
    ...
    private static boolean[][] TABELA05 = {
        ...
        {T, F, F, F, F, F, F, F, F, F, F, F, T, F, F},
        {T, F, F, T, T, F, T, T, F, F, F, T, T, F, F},
        {T, F, F, T, F, T, F, F, T, T, F, F, T, T, T},
    ...
    private static boolean[][] TABELA10 = {
        {F, T, F, F, F, F, F, F, F, F, F, F, T, T},
        {T, F, T, F, F, F, F, F, F, F, F, T, T, F},
        {F, F, F, T, F, T, F, T, T, T, F, T, F, T},
        {F, F, F, T, F, T, F, T, T, T, F, T, F, T},
