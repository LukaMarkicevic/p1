...
public class Test38 {
    ...
    private static boolean[][] TABELA01 = {
        ...
        {F, T, F, T, F, F, F, F, F, F, F, F, T, T, F, T},
        {F, T, T, T, F, T, T, T, F, T, F, T, F, F, F, F},
        {F, F, T, T, F, T, T, F, T, T, T, T, F, F, T, T},
        {T, T, T, F, T, T, T, F, F, T, T, T, T, T, T, F},
    ...
    private static boolean[][] TABELA04 = {
        ...
        {F, F, T, T, F, F, F, F, T, F, F, F, F, F, T, F},
        {F, F, T, T, F, F, F, T, T, T, T, F, F, T, F, F},
        {F, T, T, F, F, F, T, F, T, T, F, F, T, T, T, F},
        {T, T, F, T, F, F, F, T, T, T, T, T, T, T, T, T},
        {F, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T},
    };

    private static boolean[][] TABELA05 = {
        {F, T, T, F, F, T, T, T, F, F, T, T, F, T, T, F, F},
        {T, T, F, T, T, F, F, F, T, F, T, F, T, F, T, F, T},
        {T, F, T, T, T, F, F, F, F, T, F, F, F, F, F, F, T},
        {F, F, T, F, T, T, T, T, T, F, F, F, F, T, F, F, F},
        {F, T, F, T, F, F, T, T, F, F, F, T, F, T, T, T, T},
        {F, T, F, T, F, T, F, T, F, T, T, T, F, F, T, F, T},
    };

    private static boolean[][] TABELA06 = {
        {F, F, F, F, F, F, F, T, F, F, F, F, T, T, T, F, F},
        {F, F, F, T, F, T, F, F, F, T, F, F, F, F, F, F, F},
        {F, T, F, F, T, F, F, F, T, F, F, F, F, T, F, T, T},
        {T, F, T, F, F, T, T, T, T, F, F, T, F, F, F, T, T},
        {F, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, F},
        {T, T, T, T, T, T, F, T, T, T, T, T, T, T, T, T, T},
    };
