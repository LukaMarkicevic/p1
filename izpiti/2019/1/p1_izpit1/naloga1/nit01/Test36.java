...
public class Test36 {
    ...
    private static boolean[][] TABELA_A = {
        {F}
    };

    private static boolean[][] TABELA_B = {
        {T}
    };
    ...
    public static void main(String[] args) {
        System.out.println(Prva.vednoBoljRes(TABELA_A));
        System.out.println(Prva.vednoBoljRes(TABELA_B));
