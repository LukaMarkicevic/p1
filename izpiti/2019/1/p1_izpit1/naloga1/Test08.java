...
public class Test08 {
    ...
    private static boolean[][] TABELA00 = {
        {F, F, F, F, F, F},
        {T, F, F, T, T, F},
        {F, T, T, F, T, T},
        {T, T, T, T, T, T},
    ...
    private static boolean[][] TABELA04 = {
        {F, T, F, F, F, F, F, F, F, F, F, F, F, F, F, F, F, T},
        {F, T, T, F, F, F, T, F, F, F, T, F, F, F, F, F, F, F},
        {F, T, T, F, F, F, F, T, F, T, F, F, F, T, T, T, F, F},
        {F, F, T, F, F, F, F, F, T, F, T, T, T, T, T, T, T, F},
        {T, F, F, T, T, F, T, F, F, T, F, T, T, T, T, T, T, T},
        {F, T, T, T, T, T, F, T, F, T, T, T, F, T, T, F, T, T},
    };

    private static boolean[][] TABELA05 = {
        {T, F, F, F, F, F, F, F, F, F, T, F, F, F, F, T, F, F},
        {F, F, T, T, T, F, F, T, F, T, F, F, T, T, F, F, F, F},
        {F, F, T, T, T, F, F, T, F, T, F, F, T, T, F, F, F, F},
        {T, T, T, T, T, F, T, T, T, T, T, T, F, T, T, F, T, T},
        {T, T, T, T, T, T, T, T, T, F, T, T, T, T, T, T, T, T},
        {T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T},
    };

    private static boolean[][] TABELA06 = {
        {F, F, F, F, F, T, T, F, F, F, F, F, F, F, F, F},
        {F, F, F, F, T, F, F, F, T, F, F, F, T, T, T, T},
        {T, T, T, T, T, T, F, F, F, F, T, F, F, T, F, F},
        {F, F, T, T, T, T, F, T, T, T, T, F, T, F, F, F},
        {F, T, F, T, F, F, F, T, F, T, T, T, T, T, T, T},
        {T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T},
    };

    private static boolean[][] TABELA07 = {
        {F, F, T, T, T, T, T, T, T, F, T, T, T, T},
        {F, F, F, T, T, F, F, F, F, F, F, F, F, F},
        {T, F, F, T, T, F, T, F, F, T, F, T, F, F},
        {T, T, F, T, T, F, T, F, F, T, T, T, F, F},
    ...
    private static boolean[][] TABELA08 = {
        ...
        {F, T, F, F, F, T, F, F, F, T, T, F, F, F, T},
        {F, F, F, F, F, F, F, F, F, F, F, T, F, F, F},
        {F, T, T, T, T, T, T, T, F, T, F, T, F, T, F},
        {T, T, T, T, F, T, T, T, T, T, T, T, T, T, F},
    ...
    private static boolean[][] TABELA10 = {
        ...
        {F, F, F, F, F, F, F, F, F, F, F, F, F, F},
        {F, F, T, T, T, T, T, F, T, T, F, T, F, T},
        {T, F, T, F, T, T, T, T, T, T, F, T, T, F},
        {T, T, T, T, T, T, T, T, T, T, F, F, T, T},
        {T, T, T, T, T, T, T, F, T, T, T, T, T, T},
    };

    public static void main(String[] args) {
        System.out.println("00: " + Prva.vednoBoljRes(TABELA00));
